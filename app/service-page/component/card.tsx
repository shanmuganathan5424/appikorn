        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center gap-[10px] w-[373.333px] flex-shrink-0 p-6 bg-white rounded-2xl drop-shadow-2xl">
            <div className="w-[67px] h-[67px] mx-auto flex items-center justify-center rounded-full bg-white shadow-md mb-4">
              <img
                src="/service-icon/cloud.svg"
                alt="Cloud Services Icon"
                className="w-8 h-8"
              />
            </div>
            <h3 className="text-[27.36px] font-semibold text-gray-900">
              Cloud Services
            </h3>
          ...
          <div className="flex flex-col items-center gap-[10px] w-[373.333px] flex-shrink-0 p-6 bg-white rounded-2xl drop-shadow-2xl">
            ...
            <p className="text-gray-600 mt-2 text-center text-[19.55px]">
              Building fast, scalable platforms.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-[10px] w-[373.333px] flex-shrink-0 p-6 bg-white rounded-2xl drop-shadow-2xl">
            <div className="w-[67px] h-[67px] mx-auto flex items-center justify-center rounded-full bg-white shadow-md mb-4">
              <img
                src="/service-icon/vr.svg"
                alt="VR/AR Technology Icon"
                className="w-8 h-8"
              />
            </div>
            <h3 className="text-[27.36px] font-semibold text-gray-900">
