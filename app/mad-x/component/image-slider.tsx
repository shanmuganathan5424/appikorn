...
export default function ImageSliderContainer() {
  ...
  return (
    <div className="bg-[#121314] w-full flex justify-center items-center py-10 sm:py-15 min-h-[640px] mb-5">
      <div className="flex flex-col sm:flex-col md:flex-row  justify-center items-center w-full  px-5 sm:px-10 gap-5 ">
        {/* LEFT STATIC TEXT & BUTTONS */}

        <div className="w-full sm:w-full xl:w-[35%] flex flex-col justify-center items-center text-white space-y-6">
          <div className="text-[20px] sm:text-[46px] font-bold text-center">
            <h1>
        ...
        {/* RIGHT SLIDER */}
        <div className="w-[90%] sm:w-[60%] md:w-[60%] overflow-hidden">
          <div
            ref={scrollRef}
