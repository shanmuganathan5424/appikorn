...
export default function FirstContainer() {
  ...
  return (
 <div className="bg-black w-full h-screen rounded-br-[80px] md:rounded-br-[200px] xl:rounded-br-[300px] flex items-center overflow-hidden">
  <div className="flex flex-col md:flex-row items-center justify-center px-4 sm:px-6 md:px-10 gap-6 sm:gap-10 lg:gap-16 max-w-screen-xl mx-auto w-full">
    ...
    >
      {/* Heading */}
      <div className="text-white text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl tracking-tight leading-tight font-bold">
        <p>Innovate with</p>
      ...
      {/* Paragraph */}
      <p className="text-white text-sm sm:text-base md:text-lg xl:text-xl font-normal leading-relaxed max-w-prose mx-auto md:mx-0">
      ...
      <Link href="/contact" passHref>
        <button
          ...
          className="text-white px-5 py-2 sm:px-6 sm:py-3 md:px-8 md:py-4 border border-purple-400 rounded-full text-sm sm:text-base md:text-lg xl:text-xl hover:bg-white hover:text-black hover:border-black transition-all duration-300 ease-in-out w-full sm:w-[80%]  mx-auto md:mx-0"
        >
