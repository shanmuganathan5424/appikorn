          ...
          <div className="max-w-[360px] z-10">
            ...
            <div className="flex flex-col gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              ...
              <p className="text-[16px] leading-5 mt-4">
                Lorem ipsum dolor sit amet consectetur. Ac aliquam tellus
                tristique imperdiet in vitae elit platea ullamcorper. Curabitur
                malesuada feugiat in morbi faucibus proin ipsum tellus a.
                Euismod eget odio eu ac aliquam. Nisl bibendum tellus ipsum
                lectus ut odio ut lorem donec. Maecenas diam amet at sapien.
                Nulla eu leo venenatis ultrices. Ornare sem velit auctor.
              </p>
